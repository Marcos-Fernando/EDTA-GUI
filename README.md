...
* The data generated by EDTA-GUI will be identical to that produced by the original EDTA. In contrast, when running <i>in AnnoTEP mode</i>, the output will include not only the EDTA results but also additional information, as described in the following section.
